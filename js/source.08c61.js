...
/* harmony import */ var symbol_observable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(86);
...
var isNil = __webpack_require__(112);
var isNil_default = /*#__PURE__*/__webpack_require__.n(isNil);

// EXTERNAL MODULE: ./node_modules/lodash/isEqualWith.js
var isEqualWith = __webpack_require__(56);
...
var _typeof = __webpack_require__(191);
...
var gud = __webpack_require__(116);
...
var path_to_regexp = __webpack_require__(87);
...
var uiActions = {
  startFetching: function startFetching() {
    return {
      type: _types__WEBPACK_IMPORTED_MODULE_0__[/* types */ "a"].START_FETCHING
    };
  },
  stopFetching: function stopFetching() {
    return {
      type: _types__WEBPACK_IMPORTED_MODULE_0__[/* types */ "a"].STOP_FETCHING
    };
  },
...
/* harmony import */ var history__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(25);
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(42);
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24);
/* harmony import */ var _ui_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(23);
/* harmony import */ var _REST_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(49);
...
var authActions = {
  authenticate: function authenticate() {
    return {
      type: _types__WEBPACK_IMPORTED_MODULE_2__[/* types */ "a"].AUTHENTICATE
    };
  },
  signInAsyncSuccess: function signInAsyncSuccess(user) {
    return {
      type: _types__WEBPACK_IMPORTED_MODULE_2__[/* types */ "a"].SIGN_IN_ASYNC_SUCCESS,
      payload: user
    };
  },
  signInAsyncError: function signInAsyncError(error) {
    return {
      type: _types__WEBPACK_IMPORTED_MODULE_2__[/* types */ "a"].SIGN_IN_ASYNC_ERROR,
      payload: error
    };
  },
  signInAsync: function signInAsync(username) {
    return (
      /*#__PURE__*/
      function () {
        ...
        _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(dispatch) {
          var response, result, token, message;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  dispatch(_ui_actions__WEBPACK_IMPORTED_MODULE_3__[/* uiActions */ "a"].startFetching());
                  dispatch({
                    type: _types__WEBPACK_IMPORTED_MODULE_2__[/* types */ "a"].SIGN_IN_ASYNC
                  });
                  _context.next = 4;
                  return _REST_index__WEBPACK_IMPORTED_MODULE_4__[/* api */ "a"].auth.signin(username);
                ...
                case 7:
                  ...
                  token = result.token, message = result.message;
                  ...
                  if (response.status === 200) {
                    ...
                    dispatch(_ui_actions__WEBPACK_IMPORTED_MODULE_3__[/* uiActions */ "a"].stopFetching());
                  }
  ...
  signOutAsync: function signOutAsync() {
    return (
      /*#__PURE__*/
      function () {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  dispatch({
                    type: _types__WEBPACK_IMPORTED_MODULE_2__[/* types */ "a"].SIGN_OUT
                  });
...
module.exports = {"bookItem":"styles-m__bookItem---3gtLV","book":"styles-m__book---3YTma","image":"styles-m__image---uJYQj","bookBody":"styles-m__bookBody---1MrqH","bookTitle":"styles-m__bookTitle---2Mkbw","bookFooter":"styles-m__bookFooter---1e8DR"};
...
// extracted by mini-css-extract-plugin
module.exports = {"viewBook":"styles-m__viewBook---S70M4","image":"styles-m__image---1QKHf","description":"styles-m__description---3-wPi","info":"styles-m__info---G4KVq"};
...
// extracted by mini-css-extract-plugin
module.exports = {"signIn":"styles-m__signIn---1-y0B","buttonStyle":"styles-m__buttonStyle---1fZgb","inputLabel":"styles-m__inputLabel---2LRjb","errorSpan":"styles-m__errorSpan---ro4ri"};
...
// Config
var MAIN_URL = "https://js-band-api.glitch.me";
// CONCATENATED MODULE: ./source/REST/api.js

var api = Object.defineProperties({
  auth: {
    signin: function signin(username) {
      return fetch("".concat(MAIN_URL, "/signin"), {
        method: 'POST',
        headers: {
  ...
  books: {
    fetch: function (_fetch) {
      ...
      return fetch("".concat(MAIN_URL, "/books"), {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
    ...
    viewBook: function viewBook(id) {
      return fetch("".concat(MAIN_URL, "/books/").concat(id), {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          Authorization: "Bearer ".concat(api.token)
...
/* concated harmony reexport api */__webpack_require__.d(__webpack_exports__, "a", function() { return api; });
/* unused concated harmony import MAIN_URL */
...
// EXTERNAL MODULE: ./source/navigation/book.js
var navigation_book = __webpack_require__(27);

// EXTERNAL MODULE: ./source/bus/auth/actions.js
var auth_actions = __webpack_require__(35);

// EXTERNAL MODULE: ./source/components/Nav/styles.m.css
var styles_m = __webpack_require__(51);
var styles_m_default = /*#__PURE__*/__webpack_require__.n(styles_m);

// CONCATENATED MODULE: ./source/components/Nav/index.js
...
var Nav_matStateToProps = function matStateToProps(state) {
  return {
...
var Nav_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    actions: Object(redux["b" /* bindActionCreators */])(objectSpread_default()({}, auth_actions["a" /* authActions */]), dispatch)
  };
};

var Nav_Nav = (_dec = Object(es["b" /* connect */])(Nav_matStateToProps, Nav_mapDispatchToProps), Object(react_router["g" /* withRouter */])(_class2 = _dec(_class2 =
/*#__PURE__*/
function (_Component) {
  ...
  function Nav(props) {
    ...
    _this = possibleConstructorReturn_default()(this, getPrototypeOf_default()(Nav).call(this, props));

    defineProperty_default()(assertThisInitialized_default()(_this), "getNav", function () {
      var _this$state = _this.state,
          username = _this$state.username,
          avatar = _this$state.avatar;
      var isAuthenticated = _this.props.isAuthenticated;
      return isAuthenticated ? react_default.a.createElement("div", {
        className: styles_m_default.a.navEnd
      }, react_default.a.createElement("button", {
        type: "button",
        onClick: _this.logout
      }, "Sign-out"), react_default.a.createElement("div", {
        className: styles_m_default.a.avatar
      }, react_default.a.createElement("img", {
        src: avatar,
        alt: username
      })), react_default.a.createElement("div", {
        className: styles_m_default.a.username
      }, react_default.a.createElement("h5", null, username))) : null;
    });
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "logout", function () {
      ...
      history.push(navigation_book["a" /* book */].signIn);
    });
  ...
  createClass_default()(Nav, [{
    ...
    value: function render() {
      var navigation = this.getNav();
      return react_default.a.createElement("section", {
        className: styles_m_default.a.navigation
      }, react_default.a.createElement("div", null, react_default.a.createElement("div", {
        className: styles_m_default.a.logo
      }, react_default.a.createElement("h4", null, "js band store / ", react_default.a.createElement("span", null, "Dima Nazarenko")))), navigation);
    }
  }]);
...
// EXTERNAL MODULE: ./source/components/NotFound/styles.m.css
var NotFound_styles_m = __webpack_require__(68);
var NotFound_styles_m_default = /*#__PURE__*/__webpack_require__.n(NotFound_styles_m);

// CONCATENATED MODULE: ./source/components/NotFound/index.js
// Core
...
var NotFound_NotFound = function NotFound() {
  return react_default.a.createElement("section", {
    className: NotFound_styles_m_default.a.notFound
  }, react_default.a.createElement("h1", {
    className: NotFound_styles_m_default.a.numbers
  }, "404"), react_default.a.createElement("h2", {
    className: NotFound_styles_m_default.a.title
  }, "NOT FOUND"), react_default.a.createElement("p", null, "please, start from ", react_default.a.createElement(react_router_dom["c" /* NavLink */], {
    to: navigation_book["a" /* book */].signIn
  }, "here")));
};
...
var plain = __webpack_require__(7);

// CONCATENATED MODULE: ./node_modules/redux-form/es/getFormValues.js


/* harmony default export */ var es_getFormValues = (getFormValues(plain["a" /* default */]));
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/extends.js
var helpers_extends = __webpack_require__(4);
var extends_default = /*#__PURE__*/__webpack_require__.n(helpers_extends);
...
/* harmony default export */ var es_Field = (es_createField(plain["a" /* default */]));
// EXTERNAL MODULE: ./node_modules/lodash/merge.js
var merge = __webpack_require__(88);
var merge_default = /*#__PURE__*/__webpack_require__.n(merge);

// EXTERNAL MODULE: ./node_modules/lodash/mapValues.js
var mapValues = __webpack_require__(89);
...
var is_promise = __webpack_require__(48);
var is_promise_default = /*#__PURE__*/__webpack_require__.n(is_promise);

// EXTERNAL MODULE: ./node_modules/redux-form/es/actionTypes.js
var actionTypes = __webpack_require__(1);
...
/* harmony default export */ var es_actions = (actions_actions);
...
var isHotReloading = __webpack_require__(69);
...
/* harmony default export */ var reduxForm = (es_createReduxForm(plain["a" /* default */]));
// EXTERNAL MODULE: ./source/components/SignIn/styles.m.css
var SignIn_styles_m = __webpack_require__(45);
var SignIn_styles_m_default = /*#__PURE__*/__webpack_require__.n(SignIn_styles_m);

// EXTERNAL MODULE: ./source/theme/images/userLogo.png
var userLogo = __webpack_require__(117);
var userLogo_default = /*#__PURE__*/__webpack_require__.n(userLogo);

// CONCATENATED MODULE: ./source/bus/validators/validators.js
...
var maxLength = function maxLength(max) {
  return function (value) {
    return value && value.length > max ? "Field is not valid. Must be ".concat(max, " characters or less") : undefined;
  };
};

var maxLength16 = maxLength(16);

var minLength = function minLength(min) {
  return function (value) {
    return value && value.length < min ? "Field is not valid. Must be ".concat(min, " characters or more") : undefined;
  };
};

var minLength4 = minLength(4);

var validators_renderField = function renderField(_ref) {
  ...
  return react_default.a.createElement("div", {
    className: SignIn_styles_m_default.a
  }, react_default.a.createElement("label", {
    className: SignIn_styles_m_default.a.inputLabel
  }, label), react_default.a.createElement("div", null, react_default.a.createElement("input", extends_default()({}, input, {
    placeholder: label,
    type: type
  })), touched && (error && react_default.a.createElement("span", {
    className: SignIn_styles_m_default.a.errorSpan
  }, error) || warning && react_default.a.createElement("span", null, warning))));
};


// CONCATENATED MODULE: ./source/components/SignIn/index.js
...
var SignIn_matStateToProps = function matStateToProps(state) {
  return {
    isFetching: state.uiReducer.isFetching,
    username: es_getFormValues('signIn')(state),
    isAuthenticated: state.authReducer.isAuthenticated
  };
};

var SignIn_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    actions: Object(redux["b" /* bindActionCreators */])(objectSpread_default()({}, auth_actions["a" /* authActions */]), dispatch)
  };
};

var SignIn_SignIn = (SignIn_dec = Object(es["b" /* connect */])(SignIn_matStateToProps, SignIn_mapDispatchToProps), SignIn_dec(_class =
/*#__PURE__*/
function (_Component) {
  inherits_default()(SignIn, _Component);
  ...
  function SignIn() {
    ...
    _this = possibleConstructorReturn_default()(this, (_getPrototypeOf2 = getPrototypeOf_default()(SignIn)).call.apply(_getPrototypeOf2, [this].concat(args)));

    defineProperty_default()(assertThisInitialized_default()(_this), "handleSubmit", function (event) {
      event.preventDefault();
      var _this$props = _this.props,
          actions = _this$props.actions,
  ...
  return SignIn;
}(react["Component"])) || _class); // eslint-disable-next-line no-class-assign

SignIn_SignIn = reduxForm({
  form: 'signIn'
})(SignIn_SignIn);
...
// EXTERNAL MODULE: ./source/bus/books/types.js
var types = __webpack_require__(44);

// EXTERNAL MODULE: ./source/bus/ui/actions.js
var ui_actions = __webpack_require__(23);

// EXTERNAL MODULE: ./source/REST/index.js + 2 modules
var REST = __webpack_require__(49);

// CONCATENATED MODULE: ./source/bus/books/actions.js
...
var booksActions = {
  fetchBooksAsyncSuccess: function fetchBooksAsyncSuccess(books) {
    return {
      type: types["a" /* types */].FETCH_BOOKS_ASYNC_SUCCESS,
      payload: books
    };
  },
  fetchBooksAsyncError: function fetchBooksAsyncError(error) {
    return {
      type: types["a" /* types */].FETCH_BOOKS_ASYNC_ERROR,
      payload: error
    };
  },
  fetchBooksAsync: function fetchBooksAsync() {
    return (
      /*#__PURE__*/
      function () {
        ...
        regenerator_default.a.mark(function _callee(dispatch) {
          ...
          return regenerator_default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  dispatch(ui_actions["a" /* uiActions */].startFetching());
                  dispatch({
                    type: types["a" /* types */].FETCH_BOOKS_ASYNC
                  });
                  _context.prev = 2;
                  _context.next = 5;
                  return REST["a" /* api */].books.fetch();
                ...
                case 8:
                  result = _context.sent;
                  dispatch(auth_actions["a" /* authActions */].authenticate());
                ...
                case 14:
                  ...
                  dispatch(ui_actions["a" /* uiActions */].emitError(_context.t0));

                case 17:
                  dispatch(ui_actions["a" /* uiActions */].stopFetching());
...
// EXTERNAL MODULE: ./source/bus/viewBook/types.js
var viewBook_types = __webpack_require__(31);

// EXTERNAL MODULE: ./source/bus/counter/types.js
var counter_types = __webpack_require__(14);

// CONCATENATED MODULE: ./source/bus/counter/actions.js
// Actions

var counterActions = {
  increment: function increment() {
    return {
      type: counter_types["a" /* types */].INCREMENT
    };
  },
  decrement: function decrement() {
    return {
      type: counter_types["a" /* types */].DECREMENT
    };
  },
  setTotalPrice: function setTotalPrice(price) {
    return {
      type: counter_types["a" /* types */].TOTAL_PRICE,
      payload: price
    };
  },
  setCount: function setCount(count) {
    return {
      type: counter_types["a" /* types */].SET_COUNT,
      payload: count
    };
  },
  setBookAvailability: function setBookAvailability(count) {
    return {
      type: counter_types["a" /* types */].BOOKS_AVAILABILITY,
      payload: count
    };
  },
  updateTotalPrice: function updateTotalPrice(price) {
    return {
      type: counter_types["a" /* types */].UPDATE_TOTAL_PRICE,
      payload: price
    };
  },
  updateTotalPriceOnBlur: function updateTotalPriceOnBlur(price) {
    return {
      type: counter_types["a" /* types */].UPDATE_TOTAL_PRICE_ON_BLUR,
      payload: price
    };
  },
  setBookPriceOnFocus: function setBookPriceOnFocus(price) {
    return {
      type: counter_types["a" /* types */].SET_BOOK_PRICE_ON_FOCUS,
      payload: price
    };
  },
  isInputValid: function isInputValid(valid) {
    return {
      type: counter_types["a" /* types */].IS_INPUT_VALID,
      payload: valid
    };
  }
};
// CONCATENATED MODULE: ./source/bus/viewBook/actions.js
...
var viewBookActions = {
  fetchBookAsyncSuccess: function fetchBookAsyncSuccess(book) {
    return {
      type: viewBook_types["a" /* types */].FETCH_BOOK_ASYNC_SUCCESS,
      payload: book
    };
  },
  fetchBookAsyncError: function fetchBookAsyncError(error) {
    return {
      type: viewBook_types["a" /* types */].FETCH_BOOK_ASYNC_ERROR,
      payload: error
    };
  },
  clearBook: function clearBook() {
    return {
      type: viewBook_types["a" /* types */].CLEAR_BOOK
    };
  },
  ...
  fetchBookAsync: function fetchBookAsync(id) {
    return (
      /*#__PURE__*/
      function () {
        var _ref = asyncToGenerator_default()(
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  dispatch(ui_actions["a" /* uiActions */].startFetching());
                  dispatch({
                    type: viewBook_types["a" /* types */].FETCH_BOOK_ASYNC
                  });
                  _context.prev = 2;
                  _context.next = 5;
                  return REST["a" /* api */].books.viewBook(id);
                ...
                case 13:
                  _context.prev = 13;
                  _context.t0 = _context["catch"](2);
                  dispatch(viewBookActions.fetchBookAsyncError(_context.t0));
                  dispatch(ui_actions["a" /* uiActions */].emitError(_context.t0));
...
// EXTERNAL MODULE: ./source/components/Book/styles.m.css
var Book_styles_m = __webpack_require__(38);
var Book_styles_m_default = /*#__PURE__*/__webpack_require__.n(Book_styles_m);

// CONCATENATED MODULE: ./source/components/Book/index.js
...
var Book_matStateToProps = function matStateToProps(state) {
  return {
    isFetching: state.uiReducer.isFetching,
...
var Book_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    actions: Object(redux["b" /* bindActionCreators */])(objectSpread_default()({}, booksActions, viewBookActions), dispatch)
  };
};

var Book_Book = (Book_dec = Object(es["b" /* connect */])(Book_matStateToProps, Book_mapDispatchToProps), Book_dec(Book_class =
/*#__PURE__*/
function (_Component) {
  inherits_default()(Book, _Component);

  function Book() {
    classCallCheck_default()(this, Book);

    return possibleConstructorReturn_default()(this, getPrototypeOf_default()(Book).apply(this, arguments));
  }
  ...
  createClass_default()(Book, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          id = _this$props.id;
      return react_default.a.createElement("div", {
        className: Book_styles_m_default.a.bookItem
      }, react_default.a.createElement("div", {
        className: Book_styles_m_default.a.book
      }, react_default.a.createElement("figure", {
        className: Book_styles_m_default.a.image
      }, react_default.a.createElement("img", {
        src: cover,
        alt: title
      })), react_default.a.createElement("div", {
        className: Book_styles_m_default.a.bookBody
      }, react_default.a.createElement("div", null, react_default.a.createElement("h5", {
        className: Book_styles_m_default.a.bookTitle
      }, title), react_default.a.createElement("p", {
        className: Book_styles_m_default.a.bookAuthor
      }, author)), react_default.a.createElement("div", {
        className: Book_styles_m_default.a.bookFooter
      }, react_default.a.createElement("p", null, "Price: $", price), react_default.a.createElement(react_router_dom["b" /* Link */], {
        to: "books/".concat(id),
        params: {
          id: id,
          price: price
  ...
  return Book;
}(react["Component"])) || Book_class);

// EXTERNAL MODULE: ./source/bus/filters/types.js
var filters_types = __webpack_require__(37);

// CONCATENATED MODULE: ./source/bus/filters/actions.js
// Actions

var filtersActions = {
  updateBooksFilter: function updateBooksFilter(title) {
    return {
  ...
  clearSearchFilter: function clearSearchFilter() {
    return {
      type: filters_types["a" /* types */].CLEAR_SEARCH_FILTER
    };
  },
...
// EXTERNAL MODULE: ./source/components/Books/styles.m.css
var Books_styles_m = __webpack_require__(118);
var Books_styles_m_default = /*#__PURE__*/__webpack_require__.n(Books_styles_m);

// CONCATENATED MODULE: ./source/components/Books/index.js
...
var Books_matStateToProps = function matStateToProps(state) {
  return {
    isFetching: state.uiReducer.isFetching,
    books: state.booksReducer.books,
...
var Books_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    actions: Object(redux["b" /* bindActionCreators */])(objectSpread_default()({}, booksActions, filtersActions), dispatch)
  };
};

var Books_Books = (Books_dec = Object(es["b" /* connect */])(Books_matStateToProps, Books_mapDispatchToProps), Books_dec(Books_class2 =
/*#__PURE__*/
function (_Component) {
  inherits_default()(Books, _Component);
  ...
  function Books() {
    ...
    classCallCheck_default()(this, Books);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = possibleConstructorReturn_default()(this, (_getPrototypeOf2 = getPrototypeOf_default()(Books)).call.apply(_getPrototypeOf2, [this].concat(args)));

    defineProperty_default()(assertThisInitialized_default()(_this), "searchBooks", function (book) {
      var tasksFilter = _this.props.tasksFilter;
      return book.title.toLowerCase().includes(tasksFilter);
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "updateBooksFilter", function (event) {
      var actions = _this.props.actions;
      actions.updateBooksFilter(event.target.value.toLocaleLowerCase());
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "handleSelectChange", function (event) {
      var actions = _this.props.actions;
      var target = event.target;
      var value = target.value;
      var name = target.name;
      actions.updateSelectChange(defineProperty_default()({}, name, value));
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "filterPrice", function (book) {
  ...
  createClass_default()(Books, [{
    ...
    value: function render() {
      ...
      var booksJSX = error || books.filter(this.searchBooks).filter(this.filterPrice).map(function (book) {
        return react_default.a.createElement(Book_Book, {
          key: book.id,
          cover: book.cover,
          title: book.title,
          author: book.author,
      ...
      return react_default.a.createElement("div", {
        ...
        className: "input-group input-group-sm mb-sm-3 col-md-4"
        ...
        className: "input-group input-group-sm mb-sm-3 col-md-3"
        ...
        value: "price"
      }, "Price"), react_default.a.createElement("option", {
        value: "15"
      }, "15 or less"), react_default.a.createElement("option", {
        value: "15-30"
      }, "15 - 30"), react_default.a.createElement("option", {
        value: "30"
      }, "30 or more ")))), react_default.a.createElement("section", {
        className: Books_styles_m_default.a.booklist
      }, booksJSX));
    }
  }]);

  return Books;
}(react["Component"])) || Books_class2);

// EXTERNAL MODULE: ./source/components/Spinner/styles.m.css
var Spinner_styles_m = __webpack_require__(119);
...
var Spinner_Spinner = (Spinner_dec = Object(es["b" /* connect */])(mapStateToProps), Spinner_dec(Spinner_class =
/*#__PURE__*/
function (_Component) {
  inherits_default()(Spinner, _Component);
  ...
  createClass_default()(Spinner, [{
    ...
    value: function render() {
      ...
      return isFetching ? react_default.a.createElement("div", {
  ...
  return Spinner;
}(react["Component"])) || Spinner_class);

// EXTERNAL MODULE: ./node_modules/classnames/index.js
var classnames = __webpack_require__(57);
var classnames_default = /*#__PURE__*/__webpack_require__.n(classnames);

// EXTERNAL MODULE: ./source/components/PriceWidget/styles.m.css
var PriceWidget_styles_m = __webpack_require__(52);
var PriceWidget_styles_m_default = /*#__PURE__*/__webpack_require__.n(PriceWidget_styles_m);

// CONCATENATED MODULE: ./source/components/PriceWidget/index.js
...
var PriceWidget_dec, PriceWidget_class2;
...
var PriceWidget_matStateToProps = function matStateToProps(state) {
  return {
...
var PriceWidget_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    actions: Object(redux["b" /* bindActionCreators */])(objectSpread_default()({}, counterActions), dispatch)
  };
};

var PriceWidget_PriceWidget = (PriceWidget_dec = Object(es["b" /* connect */])(PriceWidget_matStateToProps, PriceWidget_mapDispatchToProps), Object(react_router["g" /* withRouter */])(PriceWidget_class2 = PriceWidget_dec(PriceWidget_class2 =
/*#__PURE__*/
function (_Component) {
  inherits_default()(PriceWidget, _Component);
  ...
  function PriceWidget() {
    ...
    classCallCheck_default()(this, PriceWidget);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = possibleConstructorReturn_default()(this, (_getPrototypeOf2 = getPrototypeOf_default()(PriceWidget)).call.apply(_getPrototypeOf2, [this].concat(args)));

    defineProperty_default()(assertThisInitialized_default()(_this), "increment", function () {
      var _this$props = _this.props,
          actions = _this$props.actions,
          price = _this$props.price;
      actions.increment();
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "decrement", function () {
      var _this$props2 = _this.props,
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "handleInputChange", function (event) {
      var actions = _this.props.actions;
      actions.setCount(event.target.value);
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "handleFocus", function () {
      var _this$props3 = _this.props,
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "handleBlur", function (event) {
      var _this$props4 = _this.props,
          actions = _this$props4.actions,
          count = _this$props4.count,
          bookAvailability = _this$props4.bookAvailability;
      var bookCountEntered = event.target.validity.valid ? event.target.value : count; // eslint-disable-next-line no-unused-expressions
  ...
  createClass_default()(PriceWidget, [{
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      var actions = this.props.actions;
      actions.setCount(1);
    ...
    value: function render() {
      var _this$props5 = this.props,
          ...
          bookAvailability = _this$props5.bookAvailability,
          totalPrice = _this$props5.totalPrice,
          isInputValid = _this$props5.isInputValid;
      var widget = classnames_default()('card bg-light mb-3 border-0', [PriceWidget_styles_m_default.a.widget]);
      var field = classnames_default()('mb-3', [PriceWidget_styles_m_default.a.field]);
      return react_default.a.createElement("div", {
        className: widget
      }, react_default.a.createElement("div", {
        className: "card-body"
        ...
        className: field
      }, react_default.a.createElement("div", null, "Price, $"), react_default.a.createElement("div", null, price)), react_default.a.createElement("div", {
        className: field
      }, react_default.a.createElement("div", null, "Count"), react_default.a.createElement("div", {
        ...
        type: "button",
        className: PriceWidget_styles_m_default.a.actionButton,
        ...
        className: field
      }, react_default.a.createElement("div", null, "Total Price"), react_default.a.createElement("div", null, " ", totalPrice ? totalPrice.toFixed(2) : null)), react_default.a.createElement("div", {
        className: "d-flex justify-content-end"
      }, isInputValid ? react_default.a.createElement("button", {
        type: "button",
        className: "btn btn-info",
        disabled: !isInputValid
      }, "add to cart") : react_default.a.createElement("div", null, react_default.a.createElement("button", {
        type: "button",
        className: "btn btn-info d-flex ml-auto",
        disabled: !isInputValid
      }, "add to cart"), react_default.a.createElement("br", null), react_default.a.createElement("span", {
        className: PriceWidget_styles_m_default.a.infoMessage
      }, "We have ", bookAvailability, " books left in stock. Please choose appropriate amount", ' ')))));
    }
  }]);

  return PriceWidget;
}(react["Component"])) || PriceWidget_class2) || PriceWidget_class2);

// EXTERNAL MODULE: ./source/components/ViewBook/styles.m.css
var ViewBook_styles_m = __webpack_require__(39);
var ViewBook_styles_m_default = /*#__PURE__*/__webpack_require__.n(ViewBook_styles_m);

// CONCATENATED MODULE: ./source/components/ViewBook/index.js
...
var ViewBook_dec, ViewBook_class;
...
var ViewBook_matStateToProps = function matStateToProps(state) {
  return {
    isFetching: state.uiReducer.isFetching,
...
var ViewBook_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    actions: Object(redux["b" /* bindActionCreators */])(objectSpread_default()({}, viewBookActions, counterActions), dispatch)
  };
};

var ViewBook_ViewBook = (ViewBook_dec = Object(es["b" /* connect */])(ViewBook_matStateToProps, ViewBook_mapDispatchToProps), Object(react_router["g" /* withRouter */])(ViewBook_class = ViewBook_dec(ViewBook_class =
/*#__PURE__*/
function (_Component) {
  inherits_default()(ViewBook, _Component);

  function ViewBook() {
    classCallCheck_default()(this, ViewBook);

    return possibleConstructorReturn_default()(this, getPrototypeOf_default()(ViewBook).apply(this, arguments));
  }

  createClass_default()(ViewBook, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this$props = this.props,
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          tags = _this$props2.book.tags;
      var viewBook = classnames_default()('row', [ViewBook_styles_m_default.a.viewBook]);
      var tagJSX = tags ? tags.map(function (tag) {
      ...
      }, react_default.a.createElement("div", null, react_default.a.createElement("figure", {
        className: ViewBook_styles_m_default.a.image
      }, react_default.a.createElement("img", {
        src: book.cover,
        alt: book.title
      })), react_default.a.createElement("div", {
        className: ViewBook_styles_m_default.a.description
      }, "Book description:", react_default.a.createElement("span", null, book.description)))), react_default.a.createElement("div", {
        className: "col-sm-12 col-md-6"
      }, react_default.a.createElement("div", {
        className: ViewBook_styles_m_default.a.info
      }, "Title: ", react_default.a.createElement("span", null, book.title)), react_default.a.createElement("div", {
        className: ViewBook_styles_m_default.a.info
      }, "Author: ", react_default.a.createElement("span", null, book.author)), react_default.a.createElement("div", {
        className: ViewBook_styles_m_default.a.info
      }, "Level: ", react_default.a.createElement("span", null, book.level)), react_default.a.createElement("div", {
        className: ViewBook_styles_m_default.a.info
      }, "Tags: ", tagJSX)))), react_default.a.createElement("div", {
        className: "col-sm-12 col-md-3"
      }, react_default.a.createElement(PriceWidget_PriceWidget, {
        price: book.price,
        bookAvailability: book.count
      }))));
    }
  }]);

  return ViewBook;
}(react["Component"])) || ViewBook_class) || ViewBook_class);
...
// CONCATENATED MODULE: ./source/pages/SignInPage.js
...
var SignInPage_SignInPage =
/*#__PURE__*/
function (_Component) {
  inherits_default()(SignInPage, _Component);

  function SignInPage() {
    classCallCheck_default()(this, SignInPage);

    return possibleConstructorReturn_default()(this, getPrototypeOf_default()(SignInPage).apply(this, arguments));
  }

  createClass_default()(SignInPage, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(Nav_Nav, null), react_default.a.createElement(components_SignIn, null));
    }
  }]);
...
// CONCATENATED MODULE: ./source/pages/NotFound.js
...
var NotFound_FourOFour =
/*#__PURE__*/
function (_Component) {
  inherits_default()(FourOFour, _Component);

  function FourOFour() {
    classCallCheck_default()(this, FourOFour);

    return possibleConstructorReturn_default()(this, getPrototypeOf_default()(FourOFour).apply(this, arguments));
  }

  createClass_default()(FourOFour, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(components_NotFound, null));
    }
  }]);
...
// CONCATENATED MODULE: ./source/pages/BooksList.js
...
var BooksList_BooksList =
/*#__PURE__*/
function (_Component) {
  inherits_default()(BooksList, _Component);

  function BooksList() {
    classCallCheck_default()(this, BooksList);

    return possibleConstructorReturn_default()(this, getPrototypeOf_default()(BooksList).apply(this, arguments));
  }

  createClass_default()(BooksList, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(Nav_Nav, null), react_default.a.createElement(Spinner_Spinner, null), react_default.a.createElement(Books_Books, null));
    }
  }]);
...
// CONCATENATED MODULE: ./source/pages/BookPage.js
...
var BookPage_BookPage =
/*#__PURE__*/
function (_Component) {
  inherits_default()(BookPage, _Component);

  function BookPage() {
    classCallCheck_default()(this, BookPage);

    return possibleConstructorReturn_default()(this, getPrototypeOf_default()(BookPage).apply(this, arguments));
  }

  createClass_default()(BookPage, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(Nav_Nav, null), react_default.a.createElement(Spinner_Spinner, null), react_default.a.createElement(ViewBook_ViewBook, null));
    }
  }]);
...
// CONCATENATED MODULE: ./source/pages/index.js
/* concated harmony reexport SignInPage */__webpack_require__.d(__webpack_exports__, "d", function() { return SignInPage_SignInPage; });
/* concated harmony reexport FourOFour */__webpack_require__.d(__webpack_exports__, "c", function() { return NotFound_FourOFour; });
/* concated harmony reexport BooksList */__webpack_require__.d(__webpack_exports__, "b", function() { return BooksList_BooksList; });
/* concated harmony reexport BookPage */__webpack_require__.d(__webpack_exports__, "a", function() { return BookPage_BookPage; });
...
// extracted by mini-css-extract-plugin
module.exports = {"navigation":"styles-m__navigation---3vARd","logo":"styles-m__logo---2bw8U","navEnd":"styles-m__navEnd---3LojC","avatar":"styles-m__avatar---9VLML","username":"styles-m__username---32E3z"};
...
// extracted by mini-css-extract-plugin
module.exports = {"widget":"styles-m__widget---2TuIs","field":"styles-m__field---cThmh","actionButton":"styles-m__actionButton---1mUMG","infoMessage":"styles-m__infoMessage---1mn7T"};
...
// extracted by mini-css-extract-plugin
module.exports = {"notFound":"styles-m__notFound---1vS39","numbers":"styles-m__numbers---JRk_m","title":"styles-m__title---1DTSZ"};
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(58), __webpack_require__(71)(module)))
...
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(121);
...
/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(5);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(13);
/* harmony import */ var _Public__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(115);
/* harmony import */ var _Private__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(120);
/* harmony import */ var _bus_auth_actions__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(35);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    actions: Object(redux__WEBPACK_IMPORTED_MODULE_8__[/* bindActionCreators */ "b"])(_babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_5___default()({}, _bus_auth_actions__WEBPACK_IMPORTED_MODULE_12__[/* authActions */ "a"]), dispatch)
  };
};

var App = (_dec = Object(react_hot_loader__WEBPACK_IMPORTED_MODULE_7__["hot"])(module), _dec2 = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__[/* connect */ "b"])(mapStateToProps, mapDispatchToProps), _dec(_class = _dec2(_class =
/*#__PURE__*/
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(App, [{
    ...
    value: function render() {
      ...
      return isAuthenticated ? react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_Private__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"], null) : react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_Public__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"], null);
    }
  }]);
...
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(18);
/* harmony import */ var _pages__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(50);
/* harmony import */ var _book__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(27);
...
function (_Component) {
  ...
  function Public() {
    ...
    return _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(Public).apply(this, arguments));
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Public, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__[/* Switch */ "d"], null, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__[/* Redirect */ "a"], {
        exact: true,
        from: "/",
        to: _book__WEBPACK_IMPORTED_MODULE_8__[/* book */ "a"].signIn
      }), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__[/* Route */ "b"], {
        component: _pages__WEBPACK_IMPORTED_MODULE_7__[/* SignInPage */ "d"],
        path: _book__WEBPACK_IMPORTED_MODULE_8__[/* book */ "a"].signIn
      }), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__[/* Route */ "b"], {
        component: _pages__WEBPACK_IMPORTED_MODULE_7__[/* FourOFour */ "c"],
        path: "*",
        exact: true
      }));
    }
...
module.exports = __webpack_require__.p + "images/userLogo.15227.png";
...
// extracted by mini-css-extract-plugin
module.exports = {"booklist":"styles-m__booklist---3dCKa"};
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(Private, _Component);

  function Private() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, Private);

    return _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(Private).apply(this, arguments));
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Private, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__[/* Switch */ "d"], null, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__[/* Route */ "b"], {
        component: _pages__WEBPACK_IMPORTED_MODULE_7__[/* BookPage */ "a"],
        path: _book__WEBPACK_IMPORTED_MODULE_8__[/* book */ "a"].book
      }), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__[/* Route */ "b"], {
        component: _pages__WEBPACK_IMPORTED_MODULE_7__[/* BooksList */ "b"],
        path: _book__WEBPACK_IMPORTED_MODULE_8__[/* book */ "a"].books
      }), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__[/* Redirect */ "a"], {
        to: _book__WEBPACK_IMPORTED_MODULE_8__[/* book */ "a"].books
      }));
    }
  }]);
...
var k=__webpack_require__(90),n="function"===typeof Symbol&&Symbol.for,p=n?Symbol.for("react.element"):60103,q=n?Symbol.for("react.portal"):60106,r=n?Symbol.for("react.fragment"):60107,t=n?Symbol.for("react.strict_mode"):60108,u=n?Symbol.for("react.profiler"):60114,v=n?Symbol.for("react.provider"):60109,w=n?Symbol.for("react.context"):60110,x=n?Symbol.for("react.concurrent_mode"):60111,y=n?Symbol.for("react.forward_ref"):60112,z=n?Symbol.for("react.suspense"):60113,aa=n?Symbol.for("react.memo"):
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(90),q=__webpack_require__(128);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));var ba=null,ca={};
...
/* harmony default export */ var es_reducer = (es_createReducer(plain["a" /* default */]));
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/objectSpread.js
var objectSpread = __webpack_require__(3);
var objectSpread_default = /*#__PURE__*/__webpack_require__.n(objectSpread);

// EXTERNAL MODULE: ./source/bus/auth/types.js
var types = __webpack_require__(24);

// CONCATENATED MODULE: ./source/bus/auth/reducer.js
...
var reducer_authReducer = function authReducer() {
  ...
  switch (action.type) {
    case types["a" /* types */].SIGN_IN_ASYNC_SUCCESS:
      return objectSpread_default()({}, state, {
        user: objectSpread_default()({}, action.payload)
      });

    case types["a" /* types */].SIGN_IN_ASYNC_ERROR:
      return objectSpread_default()({}, state, {
        error: action.payload
      });

    case types["a" /* types */].AUTHENTICATE:
      return objectSpread_default()({}, state, {
        isAuthenticated: true
      });

    case types["a" /* types */].SIGN_OUT:
      return objectSpread_default()({}, state, {
        isAuthenticated: false
      });
...
var ui_types = __webpack_require__(43);
...
var reducer_uiReducer = function uiReducer() {
...
// EXTERNAL MODULE: ./source/bus/books/types.js
var books_types = __webpack_require__(44);

// CONCATENATED MODULE: ./source/bus/books/reducer.js


var books_reducer_initialState = {
  books: [],
  error: false
};
var reducer_booksReducer = function booksReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : books_reducer_initialState;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case books_types["a" /* types */].FETCH_BOOKS_ASYNC_SUCCESS:
      return objectSpread_default()({}, state, {
        books: action.payload
      });

    case books_types["a" /* types */].FETCH_BOOKS_ASYNC_ERROR:
      return objectSpread_default()({}, state, {
        error: action.payload
      });
...
// CONCATENATED MODULE: ./source/bus/viewBook/reducer.js


var viewBook_reducer_initialState = {
  book: {},
  error: false
};
var reducer_viewBookReducer = function viewBookReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : viewBook_reducer_initialState;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case viewBook_types["a" /* types */].FETCH_BOOK_ASYNC_SUCCESS:
      return objectSpread_default()({}, state, {
        book: action.payload
      });

    case viewBook_types["a" /* types */].FETCH_BOOK_ASYNC_ERROR:
      return objectSpread_default()({}, state, {
        error: action.payload
      });

    case viewBook_types["a" /* types */].CLEAR_BOOK:
      return objectSpread_default()({}, state, {
        book: {}
      });
...
var filters_reducer_initialState = {
  price: 'price',
  tasksFilter: ''
};
var reducer_filtersReducer = function filtersReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : filters_reducer_initialState;
  var action = arguments.length > 1 ? arguments[1] : undefined;
  ...
  switch (action.type) {
    ...
    case filters_types["a" /* types */].CLEAR_SEARCH_FILTER:
      return objectSpread_default()({}, state, {
        tasksFilter: ''
      });
...
// CONCATENATED MODULE: ./source/bus/counter/reducer.js


var counter_reducer_initialState = {
  count: 1,
  totalPrice: null,
...
var reducer_counterReducer = function counterReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : counter_reducer_initialState;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case counter_types["a" /* types */].INCREMENT:
      return objectSpread_default()({}, state, {
        count: Math.min(state.booksAvailability, state.count + 1)
      });

    case counter_types["a" /* types */].DECREMENT:
      return objectSpread_default()({}, state, {
        count: Math.max(1, state.count - 1)
      });

    case counter_types["a" /* types */].TOTAL_PRICE:
      return objectSpread_default()({}, state, {
        totalPrice: action.payload
      });

    case counter_types["a" /* types */].UPDATE_TOTAL_PRICE:
      return objectSpread_default()({}, state, {
        totalPrice: action.payload * state.count
      });

    case counter_types["a" /* types */].BOOKS_AVAILABILITY:
      return objectSpread_default()({}, state, {
        booksAvailability: action.payload
      });

    case counter_types["a" /* types */].SET_COUNT:
      return objectSpread_default()({}, state, {
        count: action.payload
      });

    case counter_types["a" /* types */].UPDATE_TOTAL_PRICE_ON_BLUR:
      return objectSpread_default()({}, state, {
        totalPrice: action.payload * state.bookPrice
      });

    case counter_types["a" /* types */].SET_BOOK_PRICE_ON_FOCUS:
      return objectSpread_default()({}, state, {
        bookPrice: action.payload
      });

    case counter_types["a" /* types */].IS_INPUT_VALID:
      return objectSpread_default()({}, state, {
...
var rootReducer = Object(redux["c" /* combineReducers */])({
  authReducer: reducer_authReducer,
  uiReducer: reducer_uiReducer,
  booksReducer: reducer_booksReducer,
  viewBookReducer: reducer_viewBookReducer,
  filtersReducer: reducer_filtersReducer,
  counterReducer: reducer_counterReducer,
  form: es_reducer
});
...
var redux_logger = __webpack_require__(113);
...
var middleware = [redux_thunk_es]; // eslint-disable-next-line no-undef
...
var init = __webpack_require__(190);

// EXTERNAL MODULE: ./source/navigation/App.js
...
Object(react_dom["render"])( // eslint-disable-next-line react/jsx-filename-extension
react_default.a.createElement(es["a" /* Provider */], {
  store: store
}, react_default.a.createElement(react_router_dom["a" /* HashRouter */], null, react_default.a.createElement(App["a" /* default */], null))), document.getElementById('app'));

/***/ })
/******/ ]);
//# sourceMappingURL=source.08c61.js.map