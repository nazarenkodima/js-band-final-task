...
var isNil = __webpack_require__(97);
var isNil_default = /*#__PURE__*/__webpack_require__.n(isNil);

// EXTERNAL MODULE: ./node_modules/lodash/isEqualWith.js
var isEqualWith = __webpack_require__(38);
...
var _typeof = __webpack_require__(174);
...
/* harmony import */ var react_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(27);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(39), __webpack_require__(52)(module)))
...
/* harmony import */ var _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
/* harmony import */ var _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16);
...
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(103);
...
/* harmony import */ var _Public__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(104);
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(App, [{
    ...
    value: function render() {
      ...
      return isAuthenticated ? null : react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_Public__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"], null);
    }
  }]);
...
var styles_m = __webpack_require__(70);
...
// CONCATENATED MODULE: ./source/navigation/book.js
var book = Object.freeze({
  signIn: '/sign-in'
});
// EXTERNAL MODULE: ./source/components/NotFound/styles.m.css
var NotFound_styles_m = __webpack_require__(49);
...
var is_promise = __webpack_require__(33);
...
var regenerator = __webpack_require__(72);
var regenerator_default = /*#__PURE__*/__webpack_require__.n(regenerator);

// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/asyncToGenerator.js
var asyncToGenerator = __webpack_require__(101);
var asyncToGenerator_default = /*#__PURE__*/__webpack_require__.n(asyncToGenerator);

// EXTERNAL MODULE: ./source/bus/signIn/types.js
...
var api = Object.defineProperties({
  auth: {
    ...
    authenticate: function authenticate() {
      return fetch("".concat(MAIN_URL, "/user/login"), {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
...
// CONCATENATED MODULE: ./source/bus/signIn/actions.js
...
var signInActions = {
  signInAsyncSuccess: function signInAsyncSuccess(user) {
    return {
      type: types["a" /* types */].SIGN_IN_ASYNC_SUCCESS,
      payload: user
    };
  },
  signInAsyncError: function signInAsyncError(error) {
    return {
      type: types["a" /* types */].SIGN_IN_ASYNC_ERROR,
      payload: error
    };
  },
          ...
          return regenerator_default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  dispatch({
                    type: types["a" /* types */].START_FETCHING
                  });
                  dispatch({
                    type: types["a" /* types */].SIGN_IN_ASYNC
                  });
                  _context.next = 4;
                  return api.auth.signin(username);
                ...
                case 7:
                  ...
                  if (response.status === 200) {
                    ...
                    dispatch({
                      type: types["a" /* types */].STOP_FETCHING
                    });
                  }
...
var SignIn_styles_m = __webpack_require__(30);
...
var userLogo = __webpack_require__(102);
...
var SignIn_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    actions: Object(redux["b" /* bindActionCreators */])(objectSpread_default()({}, signInActions), dispatch)
  };
};
...
// CONCATENATED MODULE: ./source/navigation/Public.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Public_Public; });
...
/*#__PURE__*/
function (_Component) {
  inherits_default()(Public, _Component);

  function Public() {
    classCallCheck_default()(this, Public);

    return possibleConstructorReturn_default()(this, getPrototypeOf_default()(Public).apply(this, arguments));
  }

  createClass_default()(Public, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_router["d" /* Switch */], null, react_default.a.createElement(react_router["a" /* Redirect */], {
        exact: true,
        from: "/",
        to: book.signIn
      }), react_default.a.createElement(react_router["b" /* Route */], {
        component: SignInPage_SignInPage,
        path: book.signIn
      }), react_default.a.createElement(react_router["b" /* Route */], {
        component: NotFound_FourOFour,
        path: "*",
        exact: true
      }));
    }
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(75),q=__webpack_require__(111);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));var ba=null,ca={};
...
// CONCATENATED MODULE: ./source/bus/signIn/reducer.js
...
var reducer_signInReducer = function signInReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case types["a" /* types */].SIGN_IN_ASYNC:
    ...
    case types["a" /* types */].START_FETCHING:
      return objectSpread_default()({}, state, {
        isFetching: true
      });

    case types["a" /* types */].STOP_FETCHING:
      return objectSpread_default()({}, state, {
        isFetching: false
      });
...
var rootReducer = Object(redux["c" /* combineReducers */])({
  signInReducer: reducer_signInReducer,
  form: es_reducer
});
...
var redux_logger = __webpack_require__(98);
...
var init = __webpack_require__(173);
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.51610.js.map